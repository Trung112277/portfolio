...
export function DashboardLoadingProvider({ children }: DashboardLoadingProviderProps) {
  ...
  if (isGlobalLoading) {
    console.log('DashboardLoadingProvider: Global loading active, rendering children directly');
    return <>{children}</>;
  }
  ...
  return (
    <DashboardLoadingContext.Provider value={{ isDashboardLoading, setIsDashboardLoading }}>
